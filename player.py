...
class Searcher():
    ...
    def see(self, move: chess.Move) -> int:
        ...
        Returns the net material gain (centipawns) for the side making `move`,
        assuming both sides recapture with their least-valuable attacker and
        either side may decline to recapture if it would lose material.
        """
